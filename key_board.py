...
##### CONSTANTS
link_bot = ''#ссылка на бота( link bot)
link_channel = ''#ссылка на канал(link channel)
link_chat = ''#ссылка на чат(link chat)
link_admin = ''#ссылка на админа(link admin)
link_support = ''#ссылка(link support)
link_soglash = ''#ссылка на пользовательское соглашение(link user aggrement)
link_video_create_room = ''#ссылка на видео по созданию комнаты в 21(link video of creating room in game 21)
link_message_adding = ''#ссылка на сообщение из канала(link to pinned message in channel)
